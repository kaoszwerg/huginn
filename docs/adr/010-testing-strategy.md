...
reverse-engineered from whatever the code happened to do. Correctness must be provable (ADR-004), and
...
- ADR-004 (verify), ADR-008 (pipeline), `.claude/rules/testing.md`.
