...
- Indexes are generated, not hand-kept (ADR-007), to extend SSOT to the indexes themselves.

## References

- ADR-007 (generation + staleness), `.claude/memory/README.md`, `scripts/setup-claude-memory.sh`.
